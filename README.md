...
Prescripto is a **full-stack MERN healthcare web application** that enables users to **book doctor appointments, manage schedules, and make secure online payments**.
