  ...
  return dashData && (
    <div className='m-5'>      
          <div className='flex flex-wrap gap-7'>
            ...
            <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-blue-200 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div className=' bg-white'>
            <div className='flex items-center gap-2.5 px-4 py-4 mt-10 rounded-t border border-blue-300'>
            ...
            <div className='pt-4 border border-t-0'>
              {
                dashData.latestAppointments.map((item, index) =>(
                  <div className='flex items-center px-6 py-3 gap-3 hover:bg-gray-200' key={index}>
                    <img className='rounded-full w-10 bg-teal-500' src={item.userData.image} alt="" />
